  ...
  return (
    <>
      ...
      {filas.map((fila, index) => (
        <Card
          key={index}
          className="shadow-lg h-auto w-80 mt-6  ml-4 rounded-xl border border-gray-200"
        >
          <CardHeader className="bg-blue-800 rounded-t-xl px-4 py-3">
            <CardTitle className="text-lg text-white">
              Fila de Atendimento
            </CardTitle>
            <CardDescription className="text-sm text-blue-100 text-2xl">
              {service}
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="p-4 text-blue-900 space-y-1">
            ...
            <p>
              ...
              {fila?.service ? fila.service : "Atendimento"}
            </p>
          </CardContent>
