...
<Landmark/>
        ...
        <p className="ml-6 mt-2 text-2xl text-blue-800">Mao Tse Tung</p>
</div>
...
{filas.map((fila, index)=>(
  ...
  <CardFooter className="p-4">
    <AlertDialog>
      <AlertDialogTrigger className="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 transition-colors">
        Sair da fila
      </AlertDialogTrigger>
      
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle className="text-lg text-blue-900">Tem certeza que deseja sair da fila?</AlertDialogTitle>
        </AlertDialogHeader>

        <AlertDialogFooter className="flex justify-end gap-2">
          <AlertDialogAction className="bg-gray-300 text-blue-900 px-4 py-2 rounded hover:bg-gray-400 transition-colors">
            Não
          </AlertDialogAction>

          <AlertDialogCancel asChild>
            <NavLink to="/" className="bg-blue-800 text-white px-4 py-2 rounded hover:bg-blue-900 transition-colors">
              Sim
            </NavLink>
          </AlertDialogCancel>
        </AlertDialogFooter>
